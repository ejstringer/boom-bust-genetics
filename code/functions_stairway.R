...
em.filtering.stairway <- function (glx) 
{
...
em.downsample <- function(gl, ndown = 32, seed = 444){
  set.seed(seed)
  indKeep <- sample(gl@ind.names, ndown)
  gl2 <- gl.keep.ind(gl, indKeep)
  return(gl2)
}


gl2stairwayplot2 <-  function(x, 
